...
const ContactMe = (props: Props) => {
  ...
  return (
    <div className="h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-4 sm:px-10 justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col space-y-4 md:space-x-10 border border-yellow-500 p-10">
        ...
        <form
          ...
          className="flex flex-col space-y-2 w-fit mx-auto px-15 sm:px-0 border border-red-500"
        >
